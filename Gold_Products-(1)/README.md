...
This folder defines all source code for the 'Gold_Products' pipeline:
...
* Take a look at the sample under "sample_users_gold_products.py" to get familiar with the syntax.
